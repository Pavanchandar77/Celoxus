    ...
    <div className="bg-[#020617] text-white min-h-[80vh] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h1 className="text-8xl md:text-9xl font-black font-display tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-500 mb-6 border-b border-indigo-500/20 pb-4 inline-block">
            404
          </h1>
