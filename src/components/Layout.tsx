    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-500 ${navClass}`}>
      <div className="max-w-7xl mx-auto px-6 h-12 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <span className={`text-2xl font-extrabold tracking-tight ${logoTextClass} transition-colors uppercase`}>Celoxus</span>
        </Link>

        <nav className={`hidden md:flex gap-10 text-sm font-bold tracking-widest uppercase ${textColorClass} transition-colors`}>
        ...
        <div className="flex items-center gap-6">
          <Link 
            to="/contact" 
            className="hidden md:flex items-center gap-2 px-7 py-2.5 rounded-full text-xs font-black tracking-widest uppercase transition-all duration-300 bg-[#049fd9] text-white hover:bg-[#037bb0] hover:scale-105 shadow-lg shadow-[#049fd9]/20"
          >
            Get Started
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-20">
          <div className="lg:col-span-4 relative pr-8">
            <Link to="/" className="flex items-center gap-3 mb-8 group">
               ...
               <span className="text-2xl font-black tracking-tight text-white group-hover:text-[#049fd9] transition-colors uppercase">Celoxus</span>
            </Link>
